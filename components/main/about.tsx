...
export default function About() {
  ...
  return (
    <section
      ref={ref}
      className={`min-h-fit flex flex-col bg-green-main-1 bg-opacity-60 rounded-t-md opacity-0 ${animations.durations} ${anim} md:max-w-3xl lg:max-w-5xl xl:max-w-7xl md:mx-auto md:mb-4`}
    >
      <h1 className="bg-dark-green-main-1 font-kalam text-3xl pl-2 py-2 sticky top-0 rounded-t-md sm:text-4xl md:text-5xl">
        About
      </h1>
