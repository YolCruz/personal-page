  ...
  return (
    <div>
      ...
      <div className="font-raleway flex flex-col items-center gap-3 mx-1">
        ...
        <p className="text-green-1 text-center text-xl font-medium">
        ...
        <Link href={link}>
          <a className="py-2 px-16 border-2 rounded-full text-white text-xl border-yellow-1 bg-gradient-to-b from-blue-3">
            Check it out
          </a>
        </Link>
      </div>
